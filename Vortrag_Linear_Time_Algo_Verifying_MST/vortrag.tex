...
\begin{frame}
	\begin{figure}
        ...
        \only<6-7> {
        	...
        	\draw [dashed, color=gray, opacity=0] (7r) -- (7) node  [sloped,pos=0.6,opacity=1,color=black] {{\footnotesize$L = \{3\}$}};
        ...
        \only<8-9> {
        	...
        	\draw [dashed, color=gray, opacity=0] (7r) -- (7) node  [sloped,pos=0.6,opacity=1,color=black] {{\footnotesize$L = \{3\}, D = \{1,3\}$}};
        	\draw [dashed, color=gray, opacity=0] (6r) -- (6) node  [sloped,pos=0.6,opacity=1,color=black] {{\footnotesize$L = \{1,2\}, D = \{1\}$}};
        ...
        \only<10-> {
        	...
        	\draw [dashed, color=gray, opacity=0] (7r) -- (7) node  [sloped,pos=0.4,opacity=1,color=black] {{\footnotesize$L = \{3\}, D = \{1\}, M = \{3, 7\}$}};
